...
## Knowledge outcomes
  - [ ] An appreciation of how data graphics can support exploratory data analysis (EDA) workflows.
...
## Skills outcomes
  ...
  - [ ] `tidyverse`-style code for computing model-expected values, and piped to ggplot2 for  exploratory analysis.
:::
