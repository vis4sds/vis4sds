...
data_gb <- bes_2019 |>
  ...
  mutate(
    ...
    swing_con_lab=if_else(constituency_name %in% c("Chorley", "Buckingham"), 0,
...
5. *Coordinates*: `coord_sf` -- the CRS, coordinate referencing system, is [OS British National Grid](https://spatialreference.org/ref/epsg/osgb-1936-british-national-grid/), so we define constituency centroids using easting and northing .
