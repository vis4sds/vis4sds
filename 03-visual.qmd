...
::: {.callout-tip}
## On colour
There are many considerations when using colour to support visual data analysis and communication. Lisa Charotte-Rost's [Guide to Colours in Data Visualization](https://blog.datawrapper.de/colorguide/) is an excellent outline of the decision-space.
:::
...
In the graphics that facet by region, our analysis suggests at a geography to voting and certainly to observed changes in voting comparing the 2017 and 2019 elections (e.g. @fig-hist-region). We end the session by generating thematic maps of the results data.
...
The details of how ggplot2 can be used in more involved visualization design is reserved for the latter chapters of the book. However, since the graphic has been discussed at length, it would be strange not to demonstrate how the encoding in the Washington Post piece can be applied here to analyse our Butler two-party swing variable [e.g. @beecham_using_2020].
