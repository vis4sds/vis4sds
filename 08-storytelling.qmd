...
* Download the [08-template.qmd]() file and save it to the `reports` folder of your `vis4sds` project.
* Open your `vis4sds` project in RStudio and load the template file by clicking `File` > `Open File ...` > `reports/08-template.qmd`.
