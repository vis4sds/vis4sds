...
#| label: fig-ft-vis
#| out.width: 95%
#| fig-cap: "[John Burn-Murdoch](https://www.ft.com/john-burn-murdoch)'s international comparison of deaths, as it appeared on [twitter](https://twitter.com/jburnmurdoch/status/1241820210455285760). For copyright reasons this is an approximate re-implementation of the original Financial Times graphic."
#| echo: false
#| eval: true
...
#| out.width: 95%
#| fig-cap: "[Aatish Bhatia](https://aatishb.com)'s [Covid Trends](https://aatishb.com/covidtrends/) chart. [Source](https://github.com/aatishb/covidtrends#credits). For copyright reasons this is an approximate re-implementation of a static from the original webpage."
#| echo: false
#| eval: true
