...
@fig-ft-vaccine presents a final example from Financial Times [@burnmurdoch_vaccines_2021] with an obviously political purpose. The graphic was created in response to some claims that it is movement restrictions (lockdowns) rather than vaccination that reduced infection rates in the country.
