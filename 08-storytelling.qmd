...
#| label: fig-ft-vis
#| out.width: 95%
#| fig-cap: "[John Burn-Murdoch](https://www.ft.com/john-burn-murdoch)'s international comparison of deaths, as it appeared on [twitter](https://twitter.com/jburnmurdoch/status/1241820210455285760). This is an approximate ggplot2 re-implementation of the original Financial Times graphic."
#| echo: false
#| eval: true
...
#| out.width: 80%
#| fig-cap: "[Aatish Bhatia](https://aatishb.com)'s [Covid Trends](https://aatishb.com/covidtrends/) chart. [Source](https://github.com/aatishb/covidtrends#credits). This is an approximate ggplot2 re-implementation of a static from the original webpage."
#| echo: false
#| eval: true
...
#| out.width: 95%
#| fig-cap: "Static image from a data story written by @flourish_masters_2021, demonstrating how connected scatterplots can be used to analyse changes in hospitalisations and deaths. **TO DO: Request permission to include screenshot.**"
#| echo: false
#| eval: true
...
#| label: fig-ft-anim
#| out.width: 100%
#| fig-cap: "[John Burn-Murdoch](https://www.ft.com/john-burn-murdoch)'s animated rescaling [via twitter](https://twitter.com/jburnmurdoch/status/1347200811303055364) demonstrating how different in terms of intensive care admissions 2020/21 is to a standard flu season. These are frames from an approximate ggplot2 re-implementation of the original Financial Times graphic. "
#| echo: false
#| eval: true
...
#| out.width: 100%
#| fig-cap: "[John Burn-Murdoch](https://www.ft.com/john-burn-murdoch)'s analysis evaluating the role of lockdown and the vaccine. An approximate ggplot2 re-implementation of the original Financial Times graphic."
#| echo: false
#| eval: true
