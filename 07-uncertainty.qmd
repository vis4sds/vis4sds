...
Cone graphic produced by National Hurricane Center [@nhc_cone_2023] and example re-design in @van_goethem_stenomaps_2014. **TODO: Permission required for cone graphic and JW redesign.**
:::
...
#| out.width: 100%
#| fig-cap: "Risk theatre of different election eve forecasts, reimplemented in ggplot2 but based on data graphics appearing in [Washington Post](https://mucollective.github.io/visualization/risk-theatre/)."
#| echo: false
#| eval: true
...
2.  That a *sample* will consist of a set of observations from this unobtainable population and that these samples will result in  different outcomes, estimated KS rates, simply by chance.
