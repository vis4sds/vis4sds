...
#| echo: false
#| out-width: "70%"
#| fig-cap: "National Hurricane Center cone design showing probable track of the centre of a cyclone."
...
#| echo: false
#| out-width: "75%"
#| fig-cap: "@van_goethem_stenomaps_2014 redesign of probable cyclone track."
knitr::include_graphics("figs/07/cone_redesign.png")
```
...
* Download the `07-template.qmd`[^07-template] file for this chapter and save it to your `vis4sds` project.
...
Finally, the Hypothetical Outcome Plot (HOP) can be easily created using \index{packages!\texttt{gganimate}} the `gganimate` package, simply by adding a call to `transition_states()` at the end of the plot specification:
