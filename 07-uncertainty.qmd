...
Cone graphic produced by National Hurricane Center [@nhc_cone_2023] and example re-design in @van_goethem_stenomaps_2014. Cone graphic re-printed with permission, credit National Oceanic and Atmospheric Administration/National Weather Service.
:::
...
4. And so  we can derive a *sampling distribution* and obtain an array of estimated KSI rates and other parameters from *re*sampling many times.
...
The technical element demonstrates how some of the uncertainty estimate examples in the chapter can be reproduced.  We will again make use of functional programming approaches via the [`purrr`](https://purrr.tidyverse.org/) package, mostly for generating and working over bootstrap resamples.
