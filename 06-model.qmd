...
#| out.width: 100%
#| fig-cap: "Residuals from uniform model comparing constituency Leave vote to GB average. **TODO: Increase region boundary thickness, text size of annotations.**"
#| echo: false
#| eval: true
...
#| label: fig-scatters
#| out.width: 90%
#| fig-cap: "Scatterplots of constituency Leave vote against candidate explanatory variables. **TODO: Annotate to mention ceiling effects on white and eu_born**"
#| echo: false
#| eval: true
#| warning: false
...
#| label: fig-pcps
#| out.width: 70%
#| fig-cap: "Parallel coordinate plot of constituency Leave vote and candidate explanatory variables. **TODO: Annotate with obsrvations. Leave and Remain constituencies do appear separable on selected expl variables.**"
#| echo: false
#| eval: true
#| warning: false
...
#| label: fig-lineup
#| out.width: 80%
#| fig-cap: "Map line-up of residuals in which the ‘real’ dataset is presented alongside 8 decoy plots generated by randomly permuting the observed residuals around constituencies. **TO DO: Update with graphic visually explaining map-line-up procedure.**"
#| echo: false
#| eval: true
#| warning: false
...
## Task
Whilst the template provides code for reproducing the faceted scatterplots and parallel coordinate plots, there are some ommissions. You will notice that in @fig-pcps, two very high Leave and Remain constiuencies are highlighted -- presented in thicker red and blue and labbeled. 

Can you update the ggplot2 spec to create a similar effect. There are different ways of doing this, ut you may want to add a separate `geom_segment()` layer `filter()`-ed on these selected boroughs. The text annotations may be generated mannualy using `annotate()` or, derived from data using `geom_text()`. 
