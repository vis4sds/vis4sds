...
::: {.callout-note}
Remembering that pipes (`|>`) take the output of a set of code and make it the input of the next set, you will notice separate lines for each call to the pipe operator. This is good practice for supporting readability of your code, and for debugging and learning how your data is affected by each line of code. Especially if `dplyr` is new to you, we recommend  you run each line of code, separated by a pipie (`|>`) in the Console and observe how the dataset is changed.
:::
...
# Calulate time elapsed between two dates in years (age).
